...
\begin{itemize}
  ...
  \begin{equation}
    p = \frac{O_{\textrm{segment}}}{O_{\textrm{sphere}}} = \frac{\pi a^{2}}{4\pi r^{2}} = \left(\frac{a}{2r}\right)^{2}.
    \label{eq:probability}
  \end{equation}

  \noindent To be able to find $p$ we need to find $r$ as $a$ is already given.
  To solve this please have a look at figure \ref{fig:ex_4_circle}.
  ...
  \begin{figure}[H]
    ...
    We consider the red triangle to obtain the radius $r$ as only $r-h$ is given in the exercise.}
    \begin{tikzpicture}
      ...
      \draw[red, thin] (0, 0) -- (2, 2);
      \draw[red, thin] (2, 2) -- (0, 2.0);
      \draw[red, thin] (0, 2.0) -- (0, 0);
    ...
    \noindent Inserting this in equation \ref{eq:probability} yields

    \begin{equation}
      p = \left(\frac{a}{2 \sqrt{a^{2} + (r - h)^{2}}}\right)^{2} = \frac{a^{2}}{4\left(a^{2} + \left(r - h\right)^{2}\right)}.
    \end{equation} 

    \noindent Inserting $a =$ \SI{0.02}{\metre} and $r - h =$ \SI{0.1}{\metre} yields $p \approx$ \num{0.00962} $\approx$ \SI{0.962}{\percent}.
